...
namespace WebApp.Controllers
{
    public class AdminController : ApiController
    {
        ...
        public IHttpActionResult ChangePrice()
        {
            ...
            Pricelist price = _unitOfWork.PriceLists.GetAll().Where((u) => u.ticketType.ToString().Equals(req["type"].Trim())).FirstOrDefault();
            var aaa = req["version"];
        ...
        public IHttpActionResult GetPriceListVersions()
        {
            ...
            List<string> prices = _unitOfWork.PriceLists.GetAll().Select(u => u.Version.ToString()).ToList();
